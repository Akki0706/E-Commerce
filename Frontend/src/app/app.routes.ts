...
export const routes: Routes = [
    ...
    {path:"admin/products/add",component:ProductsFormComponent,canActivate:[adminGuard]},
    {path:"admin/products/:id", component:ProductsFormComponent,canActivate:[adminGuard]},
    ...
    {path:"review",component:ProductReviewsComponent,canActivate:[authGuard]},
